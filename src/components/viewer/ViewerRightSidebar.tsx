...
const ViewerRightSidebar = ({
  ...
  return (
    <>
      <aside className='bg-[#161616] border-l border-white/10 flex z-50 shadow-2xl relative shrink-0 w-115'>
        {/* --- [A] Main Content Area --- */}
      ...
      {/* 리포트 모달 */}
      {isReportModalOpen && <ReportGenerationModal objectId={objectId} onClose={() => setIsReportModalOpen(false)} />}
    </>
  );
};
